...
public class PathFinder {
    ...
    public List<Vec2> findPath(Enemy enemy, float targetWorldX, float targetWorldY) {
        ...
        while (!open.isEmpty()) {
            ...
            for (int[] dir : DIRS) {
                ...
                if (!collisionSystem.canStandAt(tileCX, tileCY, ew, eh)) continue;
                ...
                if (dir[0] != 0 && dir[1] != 0) {
                    ...
                    if (!collisionSystem.canStandAt(cx1, cy1, ew, eh) ||
                            !collisionSystem.canStandAt(cx2, cy2, ew, eh)) continue;
                }
